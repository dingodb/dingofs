...
#ifndef DINGOFS_CACHE_V2_CORE_REACTOR_DOORBELL_H_
#define DINGOFS_CACHE_V2_CORE_REACTOR_DOORBELL_H_
...
class Parker {
 public:
  ...
  bool WaitFor(Ready ready, uint64_t timeout_ns) {
    ...
    const bool woken = cv_.wait_for(lock, std::chrono::nanoseconds(timeout_ns),
...
#endif  // DINGOFS_CACHE_V2_CORE_REACTOR_DOORBELL_H_
