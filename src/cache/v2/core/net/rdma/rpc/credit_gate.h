...
#ifndef DINGOFS_CACHE_V2_CORE_NET_RDMA_RPC_CREDIT_GATE_H_
#define DINGOFS_CACHE_V2_CORE_NET_RDMA_RPC_CREDIT_GATE_H_
...
#endif  // DINGOFS_CACHE_V2_CORE_NET_RDMA_RPC_CREDIT_GATE_H_
