...
#ifndef DINGOFS_CACHE_V2_CORE_NET_RDMA_CONNECTION_H_
#define DINGOFS_CACHE_V2_CORE_NET_RDMA_CONNECTION_H_
...
#endif  // DINGOFS_CACHE_V2_CORE_NET_RDMA_CONNECTION_H_
