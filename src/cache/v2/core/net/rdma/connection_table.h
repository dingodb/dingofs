...
#ifndef DINGOFS_CACHE_V2_CORE_NET_RDMA_CONNECTION_TABLE_H_
#define DINGOFS_CACHE_V2_CORE_NET_RDMA_CONNECTION_TABLE_H_
...
#endif  // DINGOFS_CACHE_V2_CORE_NET_RDMA_CONNECTION_TABLE_H_
