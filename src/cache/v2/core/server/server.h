...
#ifndef DINGOFS_CACHE_V2_CORE_SERVER_SERVER_H_
#define DINGOFS_CACHE_V2_CORE_SERVER_SERVER_H_
...
#include "cache/v2/core/server/service_table.h"
...
#endif  // DINGOFS_CACHE_V2_CORE_SERVER_SERVER_H_
