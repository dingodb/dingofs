...
#ifndef DINGOFS_CACHE_V2_CORE_SERVER_PROTO_BINDING_H_
#define DINGOFS_CACHE_V2_CORE_SERVER_PROTO_BINDING_H_
...
#endif  // DINGOFS_CACHE_V2_CORE_SERVER_PROTO_BINDING_H_
