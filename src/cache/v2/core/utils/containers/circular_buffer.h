...
#ifndef DINGOFS_CACHE_CORE_UTILS_CONTAINERS_CIRCULAR_BUFFER_H_
#define DINGOFS_CACHE_CORE_UTILS_CONTAINERS_CIRCULAR_BUFFER_H_
...
#endif  // DINGOFS_CACHE_CORE_UTILS_CONTAINERS_CIRCULAR_BUFFER_H_
