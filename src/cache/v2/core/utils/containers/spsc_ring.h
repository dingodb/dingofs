...
#ifndef DINGOFS_CACHE_CORE_UTILS_CONTAINERS_SPSC_RING_H_
#define DINGOFS_CACHE_CORE_UTILS_CONTAINERS_SPSC_RING_H_
...
#endif  // DINGOFS_CACHE_CORE_UTILS_CONTAINERS_SPSC_RING_H_
