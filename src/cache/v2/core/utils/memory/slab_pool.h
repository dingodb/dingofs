...
#ifndef DINGOFS_CACHE_CORE_UTILS_MEMORY_SLAB_POOL_H_
#define DINGOFS_CACHE_CORE_UTILS_MEMORY_SLAB_POOL_H_
...
class SlabPool {
 public:
  ...
  size_t superblock_count() const { return meta_.size(); }
 ...
 private:
  ...
  char* base_ = nullptr;
  size_t total_ = 0;
  uint16_t free_head_ = kNilIndex;  // free-superblock list through meta_.next
...
#endif  // DINGOFS_CACHE_CORE_UTILS_MEMORY_SLAB_POOL_H_
