...
#ifndef DINGOFS_CACHE_CORE_UTILS_MEMORY_MEMORY_H_
#define DINGOFS_CACHE_CORE_UTILS_MEMORY_MEMORY_H_
...
inline constexpr size_t kMaxSlabSize = 4096;
...
#endif  // DINGOFS_CACHE_CORE_UTILS_MEMORY_MEMORY_H_
