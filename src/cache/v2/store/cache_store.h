...
#ifndef DINGOFS_CACHE_V2_STORE_CACHE_STORE_H_
#define DINGOFS_CACHE_V2_STORE_CACHE_STORE_H_
...
#include "cache/v2/store/stats.h"
...
class CacheStore {
 public:
  ...
  virtual Future<bool> IsFull(BlockHandle handle) = 0;
...
#endif  // DINGOFS_CACHE_V2_STORE_CACHE_STORE_H_
