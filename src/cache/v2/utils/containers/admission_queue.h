...
#ifndef DINGOFS_CACHE_V2_UTILS_CONTAINERS_ADMISSION_QUEUE_H_
#define DINGOFS_CACHE_V2_UTILS_CONTAINERS_ADMISSION_QUEUE_H_
...
#endif  // DINGOFS_CACHE_V2_UTILS_CONTAINERS_ADMISSION_QUEUE_H_
