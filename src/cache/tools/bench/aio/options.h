...
#ifndef DINGOFS_SRC_CACHE_TOOLS_BENCH_AIO_OPTIONS_H_
#define DINGOFS_SRC_CACHE_TOOLS_BENCH_AIO_OPTIONS_H_
...
std::string Validate(Options* o);  // converts rw_str, checks ranges; "" = ok
...
#endif  // DINGOFS_SRC_CACHE_TOOLS_BENCH_AIO_OPTIONS_H_
