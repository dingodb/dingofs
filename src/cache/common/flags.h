...
#ifndef DINGOFS_CACHE_COMMON_FLAGS_H_
#define DINGOFS_CACHE_COMMON_FLAGS_H_

#include <gflags/gflags_declare.h>

// Flag declarations for the legacy cache module (src/cache, namespace
// dingofs::cache). Definitions live next to their users under src/cache.
// The blockcache module declares its own flags in common/options/cache.h
// (namespace dingofs::blockcache). Many names overlap, but the two modules are
// built into different binaries and must not share a declaration header.
...
#endif  // DINGOFS_CACHE_COMMON_FLAGS_H_
