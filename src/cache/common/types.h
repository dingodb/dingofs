...
#ifndef DINGOFS_SRC_CACHE_COMMON_TYPES_H_
#define DINGOFS_SRC_CACHE_COMMON_TYPES_H_
...
using Status = dingofs::Status;

using dingofs::base::math::kMiB;  // NOLINT
using dingofs::utils::TaskThreadPool;

}  // namespace cache
}  // namespace dingofs

#endif  // DINGOFS_SRC_CACHE_COMMON_TYPES_H_
