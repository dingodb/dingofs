...
class EventDispatcher {
 public:
  ...
  Status AddEvent(int fd, EventType type, EventHandlerSPtr handler);
 ...
 private:
  ...
  void AddHandler(int fd, EventHandlerSPtr handler) {
  ...
  void GetHandler(int fd, EventHandlerSPtr& handler) {
    std::lock_guard<bthread::Mutex> guard(mutex_);
  ...
  std::unordered_map<int, EventHandlerSPtr> handlers_;
};
