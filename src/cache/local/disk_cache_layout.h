...
#ifndef DINGOFS_SRC_CACHE_LOCAL_DISK_CACHE_LAYOUT_H_
#define DINGOFS_SRC_CACHE_LOCAL_DISK_CACHE_LAYOUT_H_
...
#endif  // DINGOFS_SRC_CACHE_LOCAL_DISK_CACHE_LAYOUT_H_
