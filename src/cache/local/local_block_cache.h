...
#ifndef DINGOFS_SRC_CACHE_LOCAL_LOCAL_BLOCK_CACHE_H_
...
class LocalBlockCache final : public BlockCache {
 public:
  explicit LocalBlockCache(StorageClient* storage_client);
  explicit LocalBlockCache(StorageClientPoolSPtr storage_client_pool);
  ~LocalBlockCache() override;
...
#endif  // DINGOFS_SRC_CACHE_LOCAL_LOCAL_BLOCK_CACHE_H_
