...
#ifndef DINGOFS_SRC_CACHE_LOCAL_DISK_HEALTH_CHECKER_H_
#define DINGOFS_SRC_CACHE_LOCAL_DISK_HEALTH_CHECKER_H_
...
#endif  // DINGOFS_SRC_CACHE_LOCAL_DISK_HEALTH_CHECKER_H_
