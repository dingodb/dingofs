...
#ifndef DINGOFS_SRC_CACHE_LOCAL_BLOCK_CACHE_UPLOADER_H_
#define DINGOFS_SRC_CACHE_LOCAL_BLOCK_CACHE_UPLOADER_H_
...
#endif  // DINGOFS_SRC_CACHE_LOCAL_BLOCK_CACHE_UPLOADER_H_
