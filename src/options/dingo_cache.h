...
#ifndef DINGOFS_SRC_OPTIONS_DINGO_CACHE_H_
#define DINGOFS_SRC_OPTIONS_DINGO_CACHE_H_
...
class CacheGroupOption : public BaseOption {
  BIND_string(group_name, "default", "");
  BIND_string(listen_ip, "127.0.0.1", "");
  BIND_uint32(listen_port, 19301, "");
...
class DingoCacheOption : public BaseOption {
  BIND_suboption(cache_group_option, "cache_group", CacheGroupOption);
...
#endif  // DINGOFS_SRC_OPTIONS_DINGO_CACHE_H_
