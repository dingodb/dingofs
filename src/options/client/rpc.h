...
class MdsRpcOption : public BaseOption {
  BIND_int32(max_rpc_timeout_ms, 2000, "");
  BIND_int32(rpc_timeout_ms, 500, "");
  BIND_int32(rpc_retry_interval_us, 50000, "");
  BIND_int32(max_failed_times_before_change_addr, 2, "");
  BIND_int32(normal_retry_times_before_trigger_wait, 3, "");
  BIND_int32(wait_sleep_ms, 1000, "");
  BIND_string(addrs, "127.0.0.1:6700,127.0.0.1:6701,127.0.0.1:6702", "");
};

class MetaRpcOption : public BaseOption {
