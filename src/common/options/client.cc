...
DEFINE_bool(vfs_enable_latency_trace, false, "enable latency trace");
...
DEFINE_uint32(vfs_meta_flush_chunk_interval_ms, 5 * 1000,
              "flush chunk interval ms.");
DEFINE_validator(vfs_meta_flush_chunk_interval_ms, brpc::PassValidate);
