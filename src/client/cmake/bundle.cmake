...
set(_AR_BIN "${CMAKE_CXX_COMPILER_AR}")
configure_file(
...
add_custom_command(
    ...
    COMMAND sh "${_BUNDLE_SH}" "${_BUNDLE_OUTPUT}"
            ...
            $<TARGET_FILE:dingofs_read_mempool>
            $<TARGET_FILE:vfs_components>
            $<TARGET_FILE:vfs_block_store>
            $<TARGET_FILE:vfs_compaction>
            $<TARGET_FILE:client_buffer>
            $<TARGET_FILE:blockcache_api>
            $<TARGET_FILE:blockcache_tier>
            $<TARGET_FILE:blockcache_remote>
            $<TARGET_FILE:blockcache_block>
            $<TARGET_FILE:blockcache_store>
            $<TARGET_FILE:blockcache_object>
            $<TARGET_FILE:blockcache_net>
            $<TARGET_FILE:blockcache_infiniband>
            $<TARGET_FILE:blockcache_core>
            $<TARGET_FILE:blockcache_common>
            $<TARGET_FILE:blockcache_status>
            $<TARGET_FILE:blockcache_utils>
            $<TARGET_FILE:mds_mds>
