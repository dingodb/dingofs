...
#ifndef DINGOFS_BLOCKCACHE_CORE_REACTOR_COROUTINE_H_
#define DINGOFS_BLOCKCACHE_CORE_REACTOR_COROUTINE_H_

// Fail in one line when a C++17 TU includes a v2 header without opting in.
#if __cplusplus < 202002L
#error \
    "blockcache needs C++20: target_compile_features(<target> PRIVATE cxx_std_20)"
#endif
...
#endif  // DINGOFS_BLOCKCACHE_CORE_REACTOR_COROUTINE_H_
