...
#ifndef DINGOFS_BLOCKCACHE_NET_RDMA_COMPLETION_POLLER_H_
#define DINGOFS_BLOCKCACHE_NET_RDMA_COMPLETION_POLLER_H_
...
#endif  // DINGOFS_BLOCKCACHE_NET_RDMA_COMPLETION_POLLER_H_
