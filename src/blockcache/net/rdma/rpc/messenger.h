...
#ifndef DINGOFS_BLOCKCACHE_NET_RDMA_RPC_MESSENGER_H_
#define DINGOFS_BLOCKCACHE_NET_RDMA_RPC_MESSENGER_H_
...
#endif  // DINGOFS_BLOCKCACHE_NET_RDMA_RPC_MESSENGER_H_
