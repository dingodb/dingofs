...
#ifndef DINGOFS_BLOCKCACHE_NET_RDMA_RPC_FRAME_POOL_H_
#define DINGOFS_BLOCKCACHE_NET_RDMA_RPC_FRAME_POOL_H_
...
#endif  // DINGOFS_BLOCKCACHE_NET_RDMA_RPC_FRAME_POOL_H_
