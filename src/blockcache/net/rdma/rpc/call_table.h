...
#ifndef DINGOFS_BLOCKCACHE_NET_RDMA_RPC_CALL_TABLE_H_
#define DINGOFS_BLOCKCACHE_NET_RDMA_RPC_CALL_TABLE_H_
...
#endif  // DINGOFS_BLOCKCACHE_NET_RDMA_RPC_CALL_TABLE_H_
