...
#ifndef DINGOFS_BLOCKCACHE_NET_INFINIBAND_QUEUE_PAIR_H_
#define DINGOFS_BLOCKCACHE_NET_INFINIBAND_QUEUE_PAIR_H_
...
#endif  // DINGOFS_BLOCKCACHE_NET_INFINIBAND_QUEUE_PAIR_H_
