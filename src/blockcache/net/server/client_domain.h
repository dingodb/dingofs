...
#ifndef DINGOFS_BLOCKCACHE_NET_SERVER_CLIENT_DOMAIN_H_
#define DINGOFS_BLOCKCACHE_NET_SERVER_CLIENT_DOMAIN_H_
...
#endif  // DINGOFS_BLOCKCACHE_NET_SERVER_CLIENT_DOMAIN_H_
