...
#ifndef DINGOFS_BLOCKCACHE_UTILS_CONTAINERS_MPSC_QUEUE_H_
#define DINGOFS_BLOCKCACHE_UTILS_CONTAINERS_MPSC_QUEUE_H_
...
#endif  // DINGOFS_BLOCKCACHE_UTILS_CONTAINERS_MPSC_QUEUE_H_
