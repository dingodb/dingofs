...
#ifndef DINGOFS_BLOCKCACHE_UTILS_CONTAINERS_CIRCULAR_BUFFER_H_
#define DINGOFS_BLOCKCACHE_UTILS_CONTAINERS_CIRCULAR_BUFFER_H_
...
#endif  // DINGOFS_BLOCKCACHE_UTILS_CONTAINERS_CIRCULAR_BUFFER_H_
