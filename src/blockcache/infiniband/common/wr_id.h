...
#ifndef DINGOFS_BLOCKCACHE_INFINIBAND_COMMON_WR_ID_H_
#define DINGOFS_BLOCKCACHE_INFINIBAND_COMMON_WR_ID_H_
...
#endif  // DINGOFS_BLOCKCACHE_INFINIBAND_COMMON_WR_ID_H_
