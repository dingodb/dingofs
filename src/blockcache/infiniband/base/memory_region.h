...
#ifndef DINGOFS_BLOCKCACHE_INFINIBAND_BASE_MEMORY_REGION_H_
#define DINGOFS_BLOCKCACHE_INFINIBAND_BASE_MEMORY_REGION_H_
...
#endif  // DINGOFS_BLOCKCACHE_INFINIBAND_BASE_MEMORY_REGION_H_
