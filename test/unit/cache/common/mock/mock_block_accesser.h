...
#ifndef DINGOFS_TEST_CACHE_COMMON_MOCK_BLOCK_ACCESSER_H_
#define DINGOFS_TEST_CACHE_COMMON_MOCK_BLOCK_ACCESSER_H_
...
#endif  // DINGOFS_TEST_CACHE_COMMON_MOCK_BLOCK_ACCESSER_H_
