...
#define OPERATOR_CAN_BYASS_PROPOSE(TYPE) \
...
OPERATOR_CAN_BYASS_PROPOSE(SetFsQuota);
OPERATOR_CAN_BYASS_PROPOSE(FlushFsUsage);
OPERATOR_CAN_BYASS_PROPOSE(SetDirQuota);
OPERATOR_CAN_BYASS_PROPOSE(DeleteDirQuota);
OPERATOR_CAN_BYASS_PROPOSE(FlushDirUsages);

READONLY_OPERATOR_CAN_BYPASS_PROPOSE(GetFsQuota);
OPERATOR_CAN_BYASS_PROPOSE(GetDirQuota);
OPERATOR_CAN_BYASS_PROPOSE(LoadDirQuotas);
// TODO(@Wine93): Replace the following methods with the
// OPERATOR_CAN_BYASS_PROPOSE
